...
drupal_add_js(drupal_get_path('theme', 'plink') . "/js/modernizr-2.0.js", 'file');

if(module_exists('skinr')){
  drupal_add_css(drupal_get_path('theme', 'plink') . '/skins/core/skinr.css', array('weight' => CSS_THEME, 'type' => 'file'));  
}
